...
/**
 * `defineAuth(options?)` — the `@concile/auth` component: password + hardened session auth. The
...
/** The default-config component — unchanged import for `concile.config.ts` files composing `auth`. */
