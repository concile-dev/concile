...
export interface EmailConfig {
  ...
  /** N4 auth-unification: the `category` passed to a composed `@concile/notifications`' `send`
...
export interface EmailOptions {
  ...
  /** N4 auth-unification: the `category` auth passes to a composed `@concile/notifications`'
