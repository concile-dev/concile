import { mutation, action, httpAction, commitThenThrow, type ActionCtx, type MutationCtx, type RegisteredFunction } from "@concile/executor";
 ...
 *  third-party token is verified once and traded directly for a Concile session (no browser
