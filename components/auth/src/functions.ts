import { mutation, query, action, commitThenThrow, type ActionCtx, type ComponentContext, type MutationCtx, type QueryCtx, type RegisteredFunction } from "@concile/executor";
