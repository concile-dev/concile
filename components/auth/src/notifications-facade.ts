/** The one method auth calls on a composed `@concile/notifications` (duck-typed from the action
 *  ctx as `ctx.notifications`). Auth does NOT depend on `@concile/notifications`; this is a
