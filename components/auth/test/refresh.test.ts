...
async function harness(opts?: Parameters<typeof defineAuth>[0]): Promise<TestConcile> {
  return createTestConcile({ modules: appModules, components: [defineAuth(opts)], schema: false });
}
