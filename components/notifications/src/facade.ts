import type { ComponentContext, ActionApi, GuestDatabaseWriter } from "@concile/executor";
 ...
 * a composed `@concile/auth`'s verified `getUserId()` (available via `cctx.components.auth` when
