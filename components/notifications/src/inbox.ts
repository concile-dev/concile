import { mutation, query, type MutationCtx, type QueryCtx, type RegisteredFunction } from "@concile/executor";
 ...
 *
 * BOUNDARY: per-user isolation is only as strong as the identity is trustworthy. With `@concile/
