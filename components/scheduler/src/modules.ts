...
/**
 * Internal modules for `@concile/scheduler` — registered on `defineScheduler()`'s `modules` map
 ...
 *    `@concile/workflow`'s `_stepDone`) actually observes the terminal failure instead of
