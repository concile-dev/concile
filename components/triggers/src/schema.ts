...
/**
 * The `@concile/triggers` component schema (namespaced `triggers/*` when composed) — design
 ...
 *   `DriverContext.readLog`'s doc comment (`@concile/component`) for why this is ALWAYS
