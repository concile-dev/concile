...
/**
 * The `@concile/workflow` component schema (namespaced `workflow/*` when composed).
 *
 ...
 *   (`fireOnComplete` in `@concile/scheduler`), reserved here for the workflow-of-workflows
