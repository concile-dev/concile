...
concile is an open-source, reactive backend you host yourself. You write your backend as regular
TypeScript functions, and concile keeps every user's screen up to date automatically.

Think of a Google Doc. When one person types, everyone else sees the change right away, with no
refresh button. concile gives your whole app that quality, for any data, and you barely have to
think about it.
...
When someone sends a message, they call a mutation. concile notices the mutation changed data your
