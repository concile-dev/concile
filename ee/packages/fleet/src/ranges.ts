 ...
 * Tier 3 Slice 8, Task 8.1 extracted them verbatim into `@concile/id-codec` (see that package's
 ...
 * could reuse the exact same conversion without depending on `@concile/fleet`. This module now
 ...
 */
export { keyToPointRange, docKeyToPointRange } from "@concile/id-codec";
