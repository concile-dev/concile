...
import { shardIdList, DEFAULT_SHARD, type ShardId } from "@concile/id-codec";
...
async function makeFleet(): Promise<{
  ...
  await pgStore.setupSchema(); // documents/indexes/persistence_globals + the concile_ts sequence
