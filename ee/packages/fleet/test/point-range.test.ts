 ...
 * this package into `@concile/id-codec` (see that package's `point-range.ts`), with `ee/packages/
 ...
 * file, via `../src/node`) and the canonical `@concile/id-codec` functions produce IDENTICAL
 * `SerializedKeyRange` output for the same inputs.
 */
describe("extraction parity: fleet's re-export vs the canonical @concile/id-codec functions", () => {
