...
import { newDocumentId, encodeStorageTableId, internalIdToHex, type InternalDocumentId } from "@concile/id-codec";
...
const BUCKET = "concile-objectstore-substrate-failover";
