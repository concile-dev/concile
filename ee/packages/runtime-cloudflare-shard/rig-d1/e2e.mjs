 ...
 *
 * Usage: node e2e.mjs --url https://concile-do-shard-d1-fixture.<subdomain>.workers.dev --admin-key <KEY>
 */
...
const URL = arg("url");
const ADMIN_KEY = arg("admin-key", process.env.CONCILE_ADMIN_KEY);
if (!URL) {
