...
// `@concile/triggers` reference pattern (see `../concile.config.ts`): a durable audit log of
...
// is INTERNAL by Concile's `_`-prefix convention (see `docs/enduser/triggers.md`'s "Handlers"
