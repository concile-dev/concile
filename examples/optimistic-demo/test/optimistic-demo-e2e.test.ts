/**
 * Pulse E2E — the demo's headline claims through the REAL machinery: the real `concile dev`
 * server, a real ConcileClient over a real WebSocket, and the demo's own delayTransport
...
import { ConcileClient, webSocketTransport, type ClientTransport, type OptimisticStoreView } from "@concile/client";
