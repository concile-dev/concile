/**
 * Pure generator for the `concile build` entrypoint. `bun build --compile` only bundles STATIC
...
export function generateEntrySource(inp: EntryInputs): string {
  const L: string[] = ["// AUTO-GENERATED by `concile build` — do not edit."];
  ...
  L.push(`import { runBinaryServer } from "@concile/cli";`);
  L.push("");
