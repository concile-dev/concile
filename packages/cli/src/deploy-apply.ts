/**
 * Server-side apply for `concile deploy`: write the pushed tree under a writable dir a sibling
 * chain from the engine's node_modules (so `@concile/*` resolves), reuse loadFunctionsDir → push,
