...
import type { EmbeddedRuntime, RuntimeHost, ServeOptions, ServerHandle } from "@concile/runtime-embedded";
import type { SyncWebSocket } from "@concile/sync";
import type { AdminApi } from "@concile/admin";
import type { StorageRoute } from "@concile/storage";
...
// `ServerHandle`/`ServeOptions` seam (in `@concile/runtime-embedded`), pinning its generic
