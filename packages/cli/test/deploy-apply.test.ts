/**
 * `applyDeploy` — the server-side funnel for `concile deploy`: write the pushed tree, reuse
...
import { defineComponent } from "@concile/component";
...
/** A temp dir NESTED under packages/cli so `@concile/*` resolves via its node_modules
...
// A minimal fake component (mirrors a real component like @concile/scheduler's "jobs" table)
