/**
 * Unit tests for the `concile serve --fleet` flag parsing + fail-fast validation (Task 6).
...
const ENV_KEYS = ["CONCILE_FLEET", "CONCILE_ADVERTISE_URL", "CONCILE_DATABASE_URL"] as const;
