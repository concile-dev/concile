 ...
 * `PostgresDocStore` over PGlite + `LeaseManager` + `installCommitGuard` (from `@concile/fleet`,
...
import { InMemoryLogSink, SimpleIndexCatalog, mutation } from "@concile/executor";
import { EmbeddedRuntime } from "@concile/runtime-embedded";
import { PostgresDocStore } from "@concile/docstore-postgres";
import { LeaseManager, installCommitGuard, type IdempotencyReplay } from "@concile/fleet";
