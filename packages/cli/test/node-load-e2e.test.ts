...
// `@concile/*` imports resolve via Node's own ancestor walk. In a real end-user project
// (single package.json, single node_modules with @concile/* installed from the registry)
...
// `packages/cli/node_modules/@concile/*` (this package's own dependencies) actually has
...
// (ERR_MODULE_NOT_FOUND for @concile/values) that has nothing to do with bundle-on-load —
 ...
 *  external @concile/* imports resolve from packages/cli's own node_modules — see the
