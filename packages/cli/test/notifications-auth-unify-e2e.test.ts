/**
 * N4 — auth unification E2E: with `@concile/notifications` composed alongside `@concile/auth`,
...
import { defineNotifications, type EmailMessage } from "@concile/notifications";
