/**
 * Tier 3 Slice 6, Task 6.4 — the HEADLINE E2E: a real `concile serve --object-store <url>` boots
...
describe("concile serve --object-store — end-to-end (fs, real server)", () => {
  it(
...
const BUCKET = "concile-objstore-serve-e2e";
...
maybeDescribe("concile serve --object-store — end-to-end (real MinIO, gated)", () => {
  afterAll(() => stopMinio());
