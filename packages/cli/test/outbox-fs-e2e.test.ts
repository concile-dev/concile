 ...
 * FILESYSTEM (fsOutbox) instead of IndexedDB. Session 1 = a real ConcileClient over a real
...
import { ConcileClient, webSocketTransport, type ClientTransport, type ClientResetInfo } from "@concile/client";
