/**
 * Shards B2a, Task 5 — dev-tier proof: `bootLoaded` is the exact boot core `concile dev` runs
 ...
 * the SAME exported router (`shardIdForKeyValue`, `@concile/id-codec`) the executor and kernel
