...
import { applyChanges, driftChecksum, type Change, type RowVersion } from "@concile/sync";
import { base64ToBytes, compareKeyBytes } from "@concile/index-key-codec";
 ...
 * `base64ToBytes` (`@concile/index-key-codec`), the exact decoder-half of the codec the server's
