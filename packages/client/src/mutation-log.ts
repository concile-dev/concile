...
export interface PendingMutation {
  ...
  /**
   * Durable-outbox identity (verdict §(d), Task 2) — present ONLY when this `ConcileClient` was
   ...
   * `@concile/sync`'s `protocol.ts`) whenever an outbox is configured — carried for park-safety
