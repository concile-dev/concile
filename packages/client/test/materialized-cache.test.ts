...
import { driftChecksum, type Change, type RowVersion, type StateModification } from "@concile/sync";
 ...
 *  decode path `renderRangeValue` uses (`@concile/index-key-codec`'s `base64ToBytes`, the mirror
