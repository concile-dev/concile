...
describe("IndexedDBOutboxStorage — schema", () => {
  it("opens ONE database named concile-outbox with both `entries` and `meta` stores (hazard 1: co-eviction is structural)", async () => {
    expect(OUTBOX_DB_NAME).toBe("concile-outbox");
