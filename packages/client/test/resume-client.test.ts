...
import { ConcileClient, memoryOutbox, OUTBOX_VERSION, type ClientTransport } from "../src/index";
...
describe("ConcileClient — resync() echoes resultHash only for answered+defined+hashed subs", () => {
...
describe("ConcileClient — QueryUnchanged vs. the first-connect drain gate (Task 2 regression)", () => {
