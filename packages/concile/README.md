...
- [`@concile/auth`](https://www.npmjs.com/package/@concile/auth) — email/OAuth sign-in, passkeys, TOTP MFA, sessions
- [`@concile/scheduler`](https://www.npmjs.com/package/@concile/scheduler) — scheduled functions and cron jobs
- [`@concile/workflow`](https://www.npmjs.com/package/@concile/workflow) — durable multi-step workflows with compensation
- [`@concile/triggers`](https://www.npmjs.com/package/@concile/triggers) — react to table changes with guaranteed delivery
- [`@concile/notifications`](https://www.npmjs.com/package/@concile/notifications) — email/SMS/push/in-app messaging
- [`@concile/authz`](https://www.npmjs.com/package/@concile/authz) — role-based authorization
...
- Examples: [chat](https://github.com/concile-dev/concile/tree/main/examples/chat),
  [auth](https://github.com/concile-dev/concile/tree/main/examples/auth-demo),
  [offline](https://github.com/concile-dev/concile/tree/main/examples/offline-demo)

License: [FSL-1.1-Apache-2.0](https://github.com/concile-dev/concile/blob/main/LICENSE) —
