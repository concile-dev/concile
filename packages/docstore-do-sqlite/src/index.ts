/**
 * `@concile/docstore-do-sqlite` — the MVCC `DocStore` over a **Durable Object's** embedded SQLite
 ...
 *
 * The MVCC `DocStore` implementation itself is REUSED verbatim from `@concile/docstore-sqlite`
...
// document-log logic lives in `@concile/docstore-sqlite`; DO-SQLite reuses it unchanged.
export { SqliteDocStore } from "@concile/docstore-sqlite";
export type { DatabaseAdapter, PreparedStatement, RunResult, SqlValue, SqlRow } from "@concile/docstore-sqlite";
