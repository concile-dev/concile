/** `@concile/docstore-postgres` — the MVCC DocStore over Postgres, plus the pg-based client. */
...
// `packages/cli/src/boot.ts`'s `makePgClient` under the Bun runtime (`concile dev`/`serve`'s
