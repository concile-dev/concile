...
// Self-contained harness (mirrors action-run.test.ts's makeRuntime): `@concile/component` and
// `@concile/runtime-embedded` both depend on `@concile/executor`, so pulling either into
