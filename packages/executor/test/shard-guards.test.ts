 ...
 * these same guards run on the laptop, in `concile dev`'s virtual shards, and on the fleet).
 *
...
import { encodeStorageIndexId, encodeStorageTableId, shardIdForKeyValue } from "@concile/id-codec";
import { indexKeyspaceId } from "@concile/index-key-codec";
import * as idCodec from "@concile/id-codec";
