 ...
 * host (which pins its one DO via `CONCILE_DO_LOCATION_HINT`) and the ee multi-shard router (which
...
export const DEPLOYMENT_LOCATION_HINT_ENV = "CONCILE_DO_LOCATION_HINT";
