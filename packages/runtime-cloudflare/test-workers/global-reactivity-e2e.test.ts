 ...
 * five scenarios work across `GLOBAL_D1_DO`), and `ConcileDurableObject`'s `/api/sync` WebSocket
 ...
 * in-process `ConcileDurableObject`. So this file's fixture (`GlobalReactivityDO`) is armed with a
