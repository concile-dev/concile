 ...
 * a Cloudflare account. `FixtureConcileDO extends ConcileDurableObject` boots the fixture app on
...
const DO = () => (env as { CONCILE_DO: DoNs }).CONCILE_DO;
...
describe("ConcileDurableObject on REAL workerd", () => {
