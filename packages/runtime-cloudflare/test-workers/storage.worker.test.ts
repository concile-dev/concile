 ...
 * achievable without a Cloudflare login. `StorageDO extends ConcileDurableObject` boots with an
 * R2-backed `BlobStore` (`@concile/blobstore-r2` over miniflare's in-memory R2 emulation bound as
