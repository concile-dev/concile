...
import type { D1Client, D1PreparedStatement } from "@concile/docstore-d1";
import { ConcileDurableObject, type DurableObjectAppConfig } from "../src/index";
 ...
 */
async function fireAlarm(state: FakeDoState, doInstance: ConcileDurableObject): Promise<void> {
 ...
 * `@concile/docstore-do-sqlite`'s own test stand-in, `MemorySqlStorage`) instead of adding a new
