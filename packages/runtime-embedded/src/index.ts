/**
 * `@concile/runtime-embedded` — the Tier 0 engine: composes the full stack into one
...
// `@concile/cli`; a Durable Object host (Slice 3) will implement the same interface.
