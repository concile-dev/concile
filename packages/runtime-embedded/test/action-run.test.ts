...
// to avoid a package-graph cycle — @concile/component/@concile/runtime-embedded both depend on
// @concile/executor). This test lives here instead, where composeComponents/EmbeddedRuntime are
