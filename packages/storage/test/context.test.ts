...
import { query, mutation, action, type RegisteredFunction } from "@concile/executor";
import type {
  BlobStore,
  UploadTarget,
  StoredBlob,
...
/**
 * A minimal in-file `BlobStore` fake (the real `MemoryBlobStore` in `@concile/blobstore`'s
