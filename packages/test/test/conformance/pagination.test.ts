...
// D2/D3: Concile's `paginate` takes `{ cursor?, pageSize, maxScan? }` (not Convex's
...
describe("conformance — pagination scanCapped", () => {
  ...
  beforeEach(async () => {
    t = await createTestConcile({ modules: { "mod.ts": capMod, "schema.ts": { default: capSchema } } });
  });
...
describe("conformance — pagination over an index", () => {
  ...
  beforeEach(async () => {
    t = await createTestConcile({ modules: { "mod.ts": idxMod, "schema.ts": { default: idxSchema } } });
  });
...
describe("conformance — desc-order pagination", () => {
  ...
  beforeEach(async () => {
    t = await createTestConcile({ modules: { "mod.ts": descMod, "schema.ts": { default: descSchema } } });
  });
...
describe("conformance — pagination with a delete between pages", () => {
  ...
  beforeEach(async () => {
    t = await createTestConcile({ modules: { "mod.ts": delMod, "schema.ts": { default: delSchema } } });
  });
...
describe("conformance — pagination stability under a concurrent insert", () => {
  ...
  beforeEach(async () => {
    t = await createTestConcile({ modules: { "mod.ts": insMod, "schema.ts": { default: insSchema } } });
  });
