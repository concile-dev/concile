...
concile's performance is measured, not asserted. Every number on this page comes from a reproducible benchmark you can run yourself (`bun run bench:*`), reported with the conditions it was measured under.
